...
import { useHouseholdWizard } from "./HouseholdWizardContext";

export function HouseholdWizardFrame({ children }: { children: React.ReactNode }) {
  const { language } = useLanguage();
  const { currentStep, currentStepIndex, steps, progress } = useHouseholdWizard();
