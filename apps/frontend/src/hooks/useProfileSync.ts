    ...
    void fetch('http://127.0.0.1:7242/ingest/03aa0d24-0050-48c3-a4eb-4c5924b7ecb7', {
      ...
      body: JSON.stringify({
        ...
        data: {
          ...
          explicitSelectedStyle: (profileData.aestheticDNA?.explicit as any)?.selectedStyle || null,
          explicitSelectedStyleType: typeof (profileData.aestheticDNA?.explicit as any)?.selectedStyle,
          explicitSelectedStyleIsEmpty: (profileData.aestheticDNA?.explicit as any)?.selectedStyle === '',
          explicitSelectedStyleIsNull: (profileData.aestheticDNA?.explicit as any)?.selectedStyle === null,
          explicitSelectedStyleIsUndefined: (profileData.aestheticDNA?.explicit as any)?.selectedStyle === undefined,
